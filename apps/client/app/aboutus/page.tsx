...
function RoundImageSection({ src, alt, text }) {
  return (
    <div className='flex flex-col items-center gap-3'>
      <div className='relative w-[118px] h-[118px] tablet:w-[189px] tablet:h-[189px] desktop:w-[320px] desktop:h-[320px] rounded-full'>
...
function page() {
  return (
    <main className='pt-[4.5rem]'>
      ...
      <div className='flex flex-col gap-[11.25rem] pt-[50px] tablet:pt-24  tablet:gap-[12rem] desktop:gap-[23rem]'>
        <section className='flex flex-col items-center justify-center gap-6 tablet:gap-8'>
          ...
          <div className='flex flex-col gap-8 desktop:flex-row'>
            ...
            <p className='flex justify-center px-4 text-sm text-center whitespace-pre-line desktop:text-start desktop:items-end tablet:text-base desktop:text-lg'>
